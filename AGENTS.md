...
Current approved visual direction: implement the generated unified mock direction with a calmer narrow left sidebar, top primary actions, a simple active "Mapa" item, compact search/filter controls, map-first center, and a polished right detail drawer. Keep this as visual-only refinement; do not change Firebase data flows, protocols, photos, documents, or point detail functions.
