...
const APP_BUILD_VERSION="2026-09-22-skip-empty-protocol-merge-v716";
...
function renderSourceChooser(site=selectedSite){
  ...
  title.textContent=siblings.length>1 ? `Zdroje na tomto místě (${siblings.length})` : "Zdroj na tomto místě";
