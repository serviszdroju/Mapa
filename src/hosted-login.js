...
function showAuthState(mode,options={}){
  ...
  status(options.message || (normalized==="logged-out" ? "Přihlaste se Google účtem @astip.cz." : ""));
...
window.showStartupLogin=(message="")=>showAuthState("logged-out",{message:message || "Přihlaste se Google účtem @astip.cz."});
